...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('frontendAssets/css/slick-theme.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('frontendAssets/css/style.css')}}" />
	<link rel="stylesheet" type="text/css" href="{{asset('frontendAssets/css/ion.rangeSlider.min.css')}}" />
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="{{route('front.home')}}" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-primary bg-dark">E</span>
				<span class="h2 text-uppercase text-white px-2">Commerce</span>
			</a>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>© Copyright 2024-2025 E-Commerce Shop. All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
...
<script src="{{asset('frontendAssets/js/bootstrap.bundle.5.1.3.min.js')}}"></script>
<script src="{{asset('frontendAssets/js/instantpages.5.1.0.min.js')}}"></script>
<script src="{{asset('frontendAssets/js/lazyload.17.6.0.min.js')}}"></script>
<script src="{{asset('frontendAssets/js/slick.min.js')}}"></script>
<script src="{{asset('frontendAssets/js/ion.rangeSlider.min.js')}}"></script>
