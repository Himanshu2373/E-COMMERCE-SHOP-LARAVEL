                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" id="description" cols="30" rows="10" placeholder="Coupon description"></textarea> 
                            <p></p>	
                        </div>
                    </div>	
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="max_uses_user">Max Uses Of User</label>
