                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="sort_description" id="sort_description" cols="10" rows="10" class="summernote" placeholder="Sort Description"></textarea>
                                </div>
                            </div>    
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="shipping_return" id="shipping_return" cols="10" rows="10" class="summernote" placeholder="Shipping and Return"></textarea>
                                </div>
                            </div>                                               
                        </div>
                    </div>	                                                                      
                    ...
                    <div class="card-body">	
                        ...
                        <div class="mb-3">
                            ...
                            <select name="size" id="size" class="form-control">
                                ...
                                <option value="{{$size->id}}">{{$size->sortname}}</option>
                                @endforeach
                                @endif
                            </select>
                        </div>
